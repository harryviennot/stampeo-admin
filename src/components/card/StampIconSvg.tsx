...
/**
 * Canonical icon registry, mirrored from the showcase/web StampIconPicker. The
 * `id` is the cross-system contract: it must match the SVG filename in
 * backend/assets/icons/ and the web registry. New icons use the Phosphor kebab
 * name; legacy ids (checkmark, food, music, paw, shopping, thumbsup, tea) stay.
 */
