...
const CHAPTER_STEPS: Array<{
  ...
  { chapter: "first-stamp",     step: "install",         label: "First stamp · Install",         shortLabel: "FS · Install" },
  { chapter: "first-stamp",     step: "stamp",           label: "First stamp · Stamp",           shortLabel: "FS · Stamp" },
